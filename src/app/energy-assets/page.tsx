  ...
  return (
    <main className="mx-auto max-w-5xl px-6 pt-28 pb-20 text-slate-100">
      ...
      <section className="space-y-6 text-white/80">
        ...
        <p>
          Every building or facility has them. Globally 16T USD per year is used for operating and managing these energy assets. Sadly, almost half of it or around 8T is lost annually for inefficient energy asset management. The reason is facilities do not know how these assets behave over time across various conditions and health spectrums. They are unable to make sense of all the data points generated by the energy assets in the facility.
        </p>
