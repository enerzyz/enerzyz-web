...
export function CircularOrbit() {
  return (
    <div className="relative flex h-80 w-80 items-center justify-center">
      ...
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-emerald-500/10 via-sky-500/5 to-purple-500/10 blur-2xl" />
      ...
      >
        <div className="absolute inset-0 grid place-items-center">
          <div className="glass-panel relative flex h-28 w-28 flex-col items-center justify-center rounded-3xl px-2 text-center">
            <span className="text-sm uppercase tracking-[0.24em] text-emerald-200/90">
              Enerzyz
            </span>
            <span className="mt-1 text-lg font-semibold">Control Core</span>
            <span className="mt-3 h-0.5 w-10 rounded-full bg-emerald-400/60" />
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="absolute left-1/2 top-4 h-3 w-3 -translate-x-1/2 rounded-full bg-emerald-300 shadow-[0_0_25px_rgba(93,255,188,0.8)]" />
        <div className="absolute right-4 top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-sky-300 shadow-[0_0_25px_rgba(88,179,255,0.8)]" />
        <div className="absolute left-1/2 bottom-4 h-3 w-3 -translate-x-1/2 rounded-full bg-purple-300 shadow-[0_0_25px_rgba(195,139,255,0.8)]" />
        <div className="absolute left-4 top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-emerald-200 shadow-[0_0_25px_rgba(93,255,188,0.6)]" />
      </motion.div>
    </div>
  );
}
